...
- Responding to analyst notes or reports
- Preparing analyst briefing materials
- Shaping AR narrative after a conversation

## Input

Use `briefs/analyst-comms-brief-template.md`.
...
## Required rubrics
- `rubrics/analyst-readiness.md`
- `rubrics/brand-fit.md`

## Done means
- Response reviewed by executive or AR lead
- Claims sourced and approved
- Ready to send or publish
